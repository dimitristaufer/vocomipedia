...
def main() -> int:
    ap = argparse.ArgumentParser(description="Build a static review dashboard for Vocomipedia canonical decks.")
    ...
    parts.extend(["</ul>", "<h2>By Deck</h2>", "<table><tr><th>Deck</th><th>Status Counts</th></tr>"])
    ...
    parts.extend(["</table>", "<h2>Needs Attention</h2>", "<table><tr><th>Deck</th><th>Entry</th><th>Headword</th><th>Review</th><th>License</th><th>Media</th><th>File</th></tr>"])
