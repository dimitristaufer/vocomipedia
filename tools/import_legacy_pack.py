...
def main() -> int:
    ap = argparse.ArgumentParser(description="Import a current Vocomi structure JSON into canonical Vocomipedia deck items.")
    ap.add_argument("--deck-code", "--pack-code", dest="pack_code", metavar="DECK_CODE", required=True)
